      ...
      <div class="modal-content">
        <div class="contact-form">
          ...
          <form action="actionadddata.php">
            ...
            <div>
              <input class="fname" type="text" name="editrfid" placeholder="Tap Kartu Lain!" value="<?= $row['rfid']; ?>" readonly/>
              <input type="text" name="editnama" placeholder="Nama Lengkap" value="<?= $row['nama']; ?>" />
              <input type="text" name="editalamat" placeholder="Alamat" value="<?= $row['alamat']; ?>"/>
              <input type="text" name="edittelepon" placeholder="Telepon" value="<?= $row['telepon']; ?>"/>
              <input type="text" name="editsaldo" placeholder="Saldo Awal" value="<?= $row['saldo']; ?>"/>
            </div>
