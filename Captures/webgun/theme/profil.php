    ...
    <body>
            ...
            <div class="nk-sidebar">
                <div class="nk-nav-scroll">
                    <ul class="metismenu" id="menu">
                        ...
                        <li>
                            <a class="has-arrow" href="index2.php" aria-expanded="false">
        ...
        ***********************************-->
        <div class="content-body">
            ...
            <div class="profile">
        <!-- Gambar Profil -->
        <img src="img.jpg" alt="Gambar Profil">
        <!-- Nama -->
        <h1>Muhamad Gunawan</h1>
        <!-- Deskripsi -->
        <p>Saya Lulusan dari Politeknik Harapan Bersama.</p>
		  <p>Saya menyukai dengan perkembangan teknologi .</p>
		  <p>Saya selalu bersemangat untuk belajar dan mengembangkan diri. Saya percaya bahwa pendidikan adalah kunci untuk mencapai kesuksesan, dan itulah mengapa saya merasa sangat beruntung menjadi lulusan dari Politeknik Harapan Bersama. Dengan latar belakang pendidikan saya, saya berharap dapat memberikan kontribusi yang berarti dalam dunia teknologi yang terus berkembang. Saya siap untuk menghadapi tantangan baru dan terus mengikuti perkembangan teknologi yang selalu menarik bagi saya.</p>

        <!-- Informasi Kontak -->
        <ul>
            <li>Email:gunawantegal3@gmail.com</li>
            <li>Telepon: 089510735378</li>
