                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <button class="btn btn-success" id="exportButtonExcel">Export to Excel</button>
                            <a href="data-hapus.php" class="btn btn-default btn-danger" height="50" width="50">Hapus Semua Data</a>
...
<script>
        ...
        // Buat salinan tabel untuk mencetak
        var tableToPrint = document.querySelector("table").cloneNode(true);

        // Buat halaman baru untuk mencetak
        var newWin = window.open("", "Print-Window");
        newWin.document.open();
        newWin.document.write('<html><head><title>Print Table data</title></head><body>');
        newWin.document.write('<h1>Data Table</h1>');
...
<script>
    document.getElementById("exportButtonExcel").addEventListener("click", function () {
        // Ambil tabel yang ingin diekspor
        var table = document.querySelector("table");

        // Buat array data dari isi tabel
        var data = [];
        var headers = [];
        ...
        for (var i = 1; i < table.rows.length; i++) {
            ...
            for (var j = 0; j < tableRow.cells.length; j++) {
                rowData[j] = tableRow.cells[j].textContent.trim();
            }
            data.push(rowData);
        }
        ...
        // Simpan file Excel dengan format xlsx
