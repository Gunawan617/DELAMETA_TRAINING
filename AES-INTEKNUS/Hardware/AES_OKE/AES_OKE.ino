...
char* ssid            = "iotgateway"; //isi dengan SSID WIFI
char* pass            = "iotgateway"; //isi dengan PASSWORD WIFI
String HOST_NAME      = "192.168.0.105"; // change to your PC's IP address
//String HOST_NAME    = "toledp.000webhostapp.com"; // change to web addrress
String PATH_NAME      = "/aes/data-api2.php";
String getData;
