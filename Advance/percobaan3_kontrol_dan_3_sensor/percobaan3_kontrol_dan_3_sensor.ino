...
char   HOST_NAME[] = "192.168.1.42"; // change to your PC's IP address
...
void loop() {
  ...
  String namadevice="Gunawan";
  //int sensor1=(bacaJarak);
  //int sensor2=(bacaLDR);
  int sensor3=random(20.100);
...
// make a HTTP request:
    ...
    client.println(HTTP_METHOD + " " + PATH_NAME + 
                   ...
                   "&sensor1=" + String(bacaJarak) + 
                   "&sensor2=" + String(bacaLDR) + 
